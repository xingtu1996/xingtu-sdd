...
***REMOVED******REMOVED*** 二、验证用例

***REMOVED******REMOVED******REMOVED*** TC-API-01: 正常下单（库存正常）
...
***REMOVED******REMOVED******REMOVED*** TC-API-02: 库存超时（模拟库存接口延迟 2s+）
...
***REMOVED******REMOVED******REMOVED*** TC-API-03: 同 key 重放（幂等）
...
***REMOVED******REMOVED******REMOVED*** 链 1: 超时降级后补偿推进
